...
class zp_flickr_widget extends WP_Widget {
	...
	function __construct() {
		...
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'zp_flickr_widget', 'description' => __('A widget that displays your Flickr photos.', 'showroom') );

		/* Widget control settings. */
		//$control_ops = array( 'width' => 300, 'height' => 350, 'id_base' => '_ad_widget' );

		/* Create the widget. */
		parent::__construct( 'zp_flickr_widget', __('Flickr Photos', 'showroom'), $widget_ops );
	}
	...
	function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e('Title:', 'showroom') ?></label>
			<input class="widefat" id="<?php echo $this->get_field_id( 'title' ); ?>" name="<?php echo $this->get_field_name( 'title' ); ?>" value="<?php echo $instance['title']; ?>" />
		</p>

		<!-- Flickr ID: Text Input -->
		<p>
			<label for="<?php echo $this->get_field_id( 'flickrID' ); ?>"><?php _e('Flickr ID:', 'showroom') ?> (<a href="http://idgettr.com/">idGettr</a>)</label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'postcount' ); ?>"><?php _e('Number of Photos:', 'showroom') ?></label>
		...
		<!-- Type: Select Box -->
		<p>
			<label for="<?php echo $this->get_field_id( 'type' ); ?>"><?php _e('Type (user or group):', 'showroom') ?></label>
		...
		<!-- Display: Select Box -->
		<p>
			<label for="<?php echo $this->get_field_id( 'display' ); ?>"><?php _e('Display (random or latest):', 'showroom') ?></label>
